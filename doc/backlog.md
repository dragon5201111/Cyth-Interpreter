...
| 15       | -              | Basic File Operations (IO Implementation) | Feature  | High     | High   | In Progress | 3/3/2026   | -         | Expose file operations with primitive functions such as open, close, read, etc.                            |
