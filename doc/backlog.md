...
| 14       | -              | Assignment Operators                      | Feature  | Low      | Medium | In Progress | 3/9/2026   | -         | Add assignment operators for all binary operators (e.g., +=, *=, etc.).                                            |
...
| 25       | -              | Angle Include Directive                   | Feature  | Low      | Low    | Done        | 3/4/2026   | 3/4/2026  | In addition to quoted files to include, add support for angle-wrapped files to include.                            |
| 26       | -              | Enhanced For Loop                         | Feature  | Low      | Medium | To Do       | -          | -         | Implement syntactic sugar for For loops (e.g., for (item : container) { ... }).                                    |