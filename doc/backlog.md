...
| 24       | -              | Include Environment Variable              | Feature  | Low      | Low    | To Do  | -          | -         | In addition to the current include directive search methods, search for files in the INCLUDE environment variable.     |
| 25       | -              | Wide String Literals                      | Feature  | High     | High   | To Do  | -          | -         | Add support for wide string literals. This includes refactoring the Value, Tokenizer, Parser, and Interpreter classes. |