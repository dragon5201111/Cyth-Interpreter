...
| 20       | -              | Primitive Function Organization           | Revision | Low      | Medium | To Do  | -          | -         | Distinguish between different types of primitive functions and separate them into different kinds of maps. |
...
| 23       | 15, 24         | Enhanced File Operations                  | Feature  | High     | High   | To Do  | -          | -         | Add additional file operations such as seek, read n bytes / characters, etc.                               |
| 24       | -              | End Of File Handling                      | Feature  | High     | High   | To Do  | -          | -         | Handle EOF for file operations. Implement this mechanic in the FileContainer.                              |